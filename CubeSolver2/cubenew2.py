...
colorama.init()
print(rf"{GREEN}          ______    __     __    _________    _________                                   ___ ___ ___                 ")
...
print(rf"{GREEN}                                                                                         |___|___|___|                     ")
print(rf"{GREEN}                            _______    _________    __      ___      ___   ________    ________         ",end='\n')
print(rf"{GREEN}                           |  _____|  |   ___   |  |  |     \  \    /  /  |  ______|  |  _____ |    ")
print(rf"{GREEN}                           | |_____   |  |   |  |  |  |      \  \  /  /   | |____     |  ______|    ")
print(rf"{GREEN}                           |_____  |  |  |   |  |  |  |       \  \/  /    |  ____|    |   \  \        ")
print(rf"{GREEN}                            _____| |  |  |___|  |  |  |____    \    /     | |______   |  | \  \       ")
print(rf"{GREEN}                           |_______|  |_________|  |_______|    \__/      |________|  |__|  \__\      ")
